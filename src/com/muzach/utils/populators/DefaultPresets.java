...
public class DefaultPresets {
    ...
    static {
        ...
        defaultPresets.add(new Preset("Happy tune", "Happy careless music that has a little bit of dreamy feeling to it.", new TimeSignature(4, 4), 50, 40, Scales.getByName("Major Scale"), 35, 50, 30));
        ...
        defaultPresets.add(new Preset("Catchy tune", "Nice and catchy melody.", new TimeSignature(4, 4), 50, 25, Scales.getByName("Dorian Mode"), 50, 50, 1));
        defaultPresets.add(new Preset("Weird tune", "Unusual rhythm with a strange melody from another world.", new TimeSignature(7, 4), 50, 25, Scales.getByName("Lydian Mode"), 50, 50, 1));
    }
